...
<p align="center">
  <strong>あらゆる屋外ルートを曲がる 共有可能な 3D ストーリーへ</strong><br>
  ハイカー、ランナー、サイクリストのために作られています。 GPX をインポートし、映画のような 3D ビデオを即座に作成します。
</p>
...
| | |
| --- | --- |
| 🏔️ **3D 地形 Viz** | 実際の標高データと衛星画像が融合します。自分の進む道を奥行きをもって視覚化します。 |
| 📍 **ルートストーリーテリング** | 再生以上のもの。キーフレーム、写真マーカー、メモを追加してストーリーを伝えます。 |
| 🎬 **映画用カメラ** | スムーズなカメラ補間ツールにより、ルートビデオが映画のように見えます。 |
| 🔒 **プライバシー第一、オフライン対応** |  |
...
- **[ホーム](https://hooosberg.github.io/TrekReel/)**
- **[サポート](https://hooosberg.github.io/TrekReel/support.html)**
- **[プライバシーポリシー](https://hooosberg.github.io/TrekReel/privacy.html)**
- **[利用規約](https://hooosberg.github.io/TrekReel/terms.html)**
- **[クレジット](https://hooosberg.github.io/TrekReel/sources.html)**
